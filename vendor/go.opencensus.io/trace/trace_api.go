...
type Span interface {
	...
	// addChild adds a child to the span.  Only used by the standard Span implementation.
	addChild()

	// makeSpanData prepares SpanData for exporting.  Only used by the standard Span implementation.
